...
<template>
  <section class="pgn-loader">
    ...
    <div class="pgn-loader__input">
      ...
      />
      <button type="button" @click="parsePgn">Parse PGN</button>
    </div>

    <p v-if="errorMessage" class="pgn-loader__error">{{ errorMessage }}</p>

    <div v-if="parsedGame" class="pgn-loader__output">
