...
const description =
	"When you blunder, which opponent piece type responds with an attack or capture on the very next move. This shows which pieces punish your mistakes most often.";
